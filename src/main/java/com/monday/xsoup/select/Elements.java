...
import com.monday.xsoup.nodes.FormElement;
...
public class Elements implements List<Element>, Cloneable {
     ...
     * <p>
     * Note that this method should not be used to clean user-submitted HTML; rather, use {@link com.monday.xsoup.safety.Cleaner} to clean HTML.
     * @return this, for chaining
     * @see Element#empty()
     * @see #empty()
     */
