package com.monday.xsoup.select;

import com.monday.xsoup.helper.Validate;
import com.monday.xsoup.nodes.Comment;
import com.monday.xsoup.nodes.Document;
import com.monday.xsoup.nodes.DocumentType;
import com.monday.xsoup.nodes.Element;
import com.monday.xsoup.nodes.Node;
import com.monday.xsoup.nodes.XmlDeclaration;
...
public abstract class Evaluator {
    ...
    public static final class AttributeStarting extends Evaluator {
        ...
        @Override
        public boolean matches(Element root, Element element) {
            List<com.monday.xsoup.nodes.Attribute> values = element.attributes().asList();
            for (com.monday.xsoup.nodes.Attribute attribute : values) {
